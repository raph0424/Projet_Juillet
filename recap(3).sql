...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 08 juil. 2019 à 16:49
...
--
-- Déchargement des données de la table `moy_de_transport`
--
...
--
ALTER TABLE `etudiant`
  MODIFY `id_etudiant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
