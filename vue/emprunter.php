...
$result = $unControleur->selectMoyTransport();
$results = $unControleur->selectEtudiant();

if(isset($_POST["Ajouter"]))
{
   $envoi = $_POST['tab'];
   $unControleur->insertEmprunter("emprunter", $_POST['id_etudiant'], $envoi);
...
<body>
 ...
 <center>
    ...
    {
        require_once("affichage/vueemprunter.php");
    }
    ?>
  </center>
